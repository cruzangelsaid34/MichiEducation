...
## 6. Privacidad
El tratamiento de datos se describe en `PRIVACY.md`. Al utilizar el sitio, aceptas ese aviso de privacidad.

## 7. Cambios y contacto
Estos términos pueden actualizarse. El uso posterior a una actualización implica su aceptación. Para asuntos legales o de propiedad intelectual, contacta a **michihub@hotmail.com**.

© 2026 Ángel Said Cruz Muñoz. Todos los derechos reservados, sujeto a la licencia indicada en `LICENSE`.
